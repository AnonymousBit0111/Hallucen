...
//  2022-11-09: OpenGL: Reverted use of glBufferSubData(), too many corruptions
//  issues + old issues seemingly can't be reproed with Intel drivers nowadays
//  (revert 2021-12-15 and 2022-05-23 changes). 2022-10-11: Using 'nullptr'
//  instead of 'NULL' as per our switch to C++11. 2022-09-27: OpenGL: Added
//  ability to '#define IMGUI_IMPL_OPENGL_DEBUG'. 2022-05-23: OpenGL: Reworking
//  2021-12-15 "Using buffer orphaning" so it only happens on Intel GPU, seems
//  to cause problems otherwise. (#4468, #4825, #4832, #5127). 2022-05-13:
//  OpenGL: Fix state corruption on OpenGL ES 2.0 due to not preserving
